...
class DictionaryOfRussian : DictionaryOfLanguage {
    ...
    override fun getMessageForAi(
        ...
        return "$latokenAbout\n\n На основании текста выше представь, что ты - предсказатель и умеешь гадать на картах Таро. \n" +
                ...
                "Напиши свое предсказание на русском языке на основании текста выше. Опиши, что означает каждая из этих карт на русском языке. " +
                "Добавь мистицизма в описание на русском языке. Твой ответ не должен превышать 700 символов и быть на русском языке. Ответ переведи на русский язык.\n "
    }
